...
namespace Data.Service
{
	...
	public class MasterTemplateService
	{
		...
		// API Controller
		public readonly string _apiController = "MasterTemplate";
		...
		// Constructor
		public MasterTemplateService(IFINSLIKClient ifinslikClient)
		{
			_ifinslikClient = ifinslikClient;
		}

		public async Task<List<MasterTemplateModel>?> GetRows(string keyword, int offset, int limit)
		{
			// var parameters = new
			// {
			// 	Keyword = keyword,
			...
			// Get List Data
			var res = await _ifinslikClient.GetRows<MasterTemplateModel>(_apiController, _apiRouteGetRows, new { Keyword = keyword, Offset = offset, Limit = limit });

			return res?.Data;
		}
		public async Task<MasterTemplateModel?> GetRowByID(string? id)
		{
			...
			// Get Single Data
			var res = await _ifinslikClient.GetRow<MasterTemplateModel>(_apiController, _apiRouteGetRowByID, parameters);

			return res?.Data;
		}
		public async Task<BodyResponse<BaseModel>> Insert(MasterTemplateModel model)
		{
			// Mengirim model ke API Insert dengan HTTP Post
			var res = await _ifinslikClient.Post(_apiController, _apiRouteInsert, model);
			return res;
		}
		public async Task<BodyResponse<object>> UpdateByID(MasterTemplateModel model)
		{
		...
		public async Task<BodyResponse<object>> ChangeStatus(MasterTemplateModel model)
		{
